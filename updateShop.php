...
<body>
    ...
    <div class="form col-lg-9">
        <form method='POST' action='./backend/updateShop.php' name="addShop" style="width: 50%;">
            <fieldset>
                <?php
                ...
                if (isset($_GET['added']) && $_GET['added'] == true) {
                    echo "<p style ='font-size:3em'>shop updated</p>";
                }
                ?>
                <h2>Update Shop</h2>
                ...
                <div class="btn">
                    <input type="button" value="Update shop" onclick="validate()">
                </div>
            </fieldset>
        </form>
    </div>
